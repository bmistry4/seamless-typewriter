path = r'C:\Users\bhumika\Documents\Projects\seamless-typewriter\videos\mysql.mp4'
...
def browse():  # to change value of a global variable inside a function apply global
    ...
    top.filename = filedialog.askopenfilename(initialdir="/home/${USER}/", title="Choose Music file")
    file = top.filename
